            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg">
                <div className="container-fluid">
                    <Link to={'/'} className="navbar-brand ms-5 event-brand animate__animated animate__bounceIn">
                        SP Project <i className="fa-solid fa-signal"></i>
                    </Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <Link to={'/add'} className="nav-link active animate__animated animate__fadeInDown text-hover" aria-current="page">Create projects</Link>
                            </li>
                            <li className="nav-item">
